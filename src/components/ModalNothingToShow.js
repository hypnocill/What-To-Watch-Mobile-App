...
class ModalNothingToShow extends Component {
  ...
  render(){
    ...
    return(
      ...
      В случай, че е станала грешка, отиди в менюто <Icon name={'list'} color={styles.secondaryColor} size={15} /> и виж кои филми си маркирал.
      Ако пък просто си гледал всички препоръчвани филми досега, защо не отидеш в менюто <Icon name={'send'} color={styles.secondaryColor} size={15} /> и не препоръчаш свой любим филм? :)
      </Text>
